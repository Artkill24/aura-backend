...
def compute_verdict(metadata: dict, visual: dict, audio: dict, signal: dict, moire: dict, prnu: dict = None) -> dict:
    ...
    visual   : 0.15
    audio    : 0.15
    signal   : 0.40  (physics — il più affidabile)
    moire    : 0.15  (screen recording — informativo, peso ridotto)
    """
    ...
    # Shield intelligente: azzera signal solo se è vera screen recording
    # Screen recording reale: moire alto + prnu basso
    # AI-generated: moire può essere alto MA prnu è anche alto
